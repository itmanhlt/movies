...
export default function AppImage() {
  return (
    <div className="relative lg:flex-grow-0 lg:max-w-[50%] lg:basis-[50%]">
      <img
        ...
        alt=""
        className="h-auto block py-0 px-[28%] relative max-w-full"
      />
      <Carousel
        className="absolute top-0 left-0 w-full block pt-[1.5%] px-[29.2%] pb-0 overflow-hidden"
        autoPlay
        infiniteLoop
        showThumbs={false}
        showStatus={false}
      ...
      >
        <div>
          <img
            ...
            src="https://demo1.cybersoft.edu.vn/static/media/banner-slider-3.33a486d1.jpg"
          />
        </div>
        <div>
          <img
        ...
        <div>
          <img
            className="rounded-[20px]"
            src="https://demo1.cybersoft.edu.vn/static/media/banner-slider-5.8a084f78.jpg"
          />
        </div>
        <div>
          <img
        ...
        <div>
          <img
            className="rounded-[20px]"
            src="https://demo1.cybersoft.edu.vn/static/media/banner-slider-2.454924ec.jpg"
          />
        </div>
      </Carousel>
    </div>
